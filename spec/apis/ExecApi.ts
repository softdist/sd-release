...
export class ExecApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async containerExec(id: string, execConfig: ExecConfig, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("ExecApi", "containerExec", "id");
        }


        // verify required parameter 'execConfig' is not null or undefined
        if (execConfig === null || execConfig === undefined) {
            throw new RequiredError("ExecApi", "containerExec", "execConfig");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(execConfig, "ExecConfig", ""),
            contentType
        );
    ...
    public async execInspect(id: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("ExecApi", "execInspect", "id");
        }
     ...
     */
    public async execResize(id: string, h: number, w: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("ExecApi", "execResize", "id");
        }


        // verify required parameter 'h' is not null or undefined
        if (h === null || h === undefined) {
            throw new RequiredError("ExecApi", "execResize", "h");
        }


        // verify required parameter 'w' is not null or undefined
        if (w === null || w === undefined) {
            throw new RequiredError("ExecApi", "execResize", "w");
        }
     ...
     */
    public async execStart(id: string, execStartConfig?: ExecStartConfig, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("ExecApi", "execStart", "id");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(execStartConfig, "ExecStartConfig", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class ExecApiResponseProcessor {
     ...
     */
     public async containerExecWithHttpInfo(response: ResponseContext): Promise<HttpInfo<IdResponse >> {
        ...
        if (isCodeInRange("409", response.httpStatusCode)) {
            ...
            throw new ApiException<ErrorResponse>(response.httpStatusCode, "container is paused", body, response.headers);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async execInspectWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ExecInspectResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ExecInspectResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ExecInspectResponse", ""
        ...
        if (isCodeInRange("404", response.httpStatusCode)) {
            ...
            throw new ApiException<ErrorResponse>(response.httpStatusCode, "No such exec instance", body, response.headers);
        }
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: ErrorResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async execResizeWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async execStartWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
        ...
        if (isCodeInRange("409", response.httpStatusCode)) {
            ...
            throw new ApiException<ErrorResponse>(response.httpStatusCode, "Container is stopped or paused", body, response.headers);
        }
