export type DockerRequestOptions = {
  ...
  export class ConnectionClient {
    ...
    private async readStatusLine(response: DockerResponse): Promise<void> {
    ...
    private async readHeaders(response: DockerResponse): Promise<void> {
    ...
    private async readBody(response: DockerResponse): Promise<void> {
      let body = '';
